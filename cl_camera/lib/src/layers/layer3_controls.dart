...
class CameraScreenControl extends ConsumerStatefulWidget {
  const CameraScreenControl({
  ...
  @override
  CameraScreenControlState createState() => CameraScreenControlState();
}

class CameraScreenControlState extends ConsumerState<CameraScreenControl>
