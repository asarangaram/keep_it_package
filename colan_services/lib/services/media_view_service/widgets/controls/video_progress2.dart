...
class VideoProgress2 extends ConsumerStatefulWidget {
  const VideoProgress2({
    required this.uri,
    super.key,
  });
  ...
  @override
  ConsumerState<VideoProgress2> createState() => _VideoProgress2State();
}

class _VideoProgress2State extends ConsumerState<VideoProgress2> {
  double? seekValue;
  @override
        ...
        return LayoutBuilder(
          builder: (context, constraints) {
            return Container(
              ...
              padding: isFullScreen ? null : const EdgeInsets.only(bottom: 8),
              child: Column(
                        ...
                        SliderTheme(
                          ...
                          child: Slider(
                            ...
                            onChangeEnd: (double value) {
                              ...
                              playerControls.seekTo(doubleToDuration(value));
                            },
                          ),
                        ),
                      ],
