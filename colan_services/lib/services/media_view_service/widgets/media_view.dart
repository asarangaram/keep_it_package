  ...
  Widget build(BuildContext context) {
    if (isPreview) {
      return GetStoreManager(
        builder: (theStore) {
          final previewUri = Uri.file(theStore.getPreviewPath2(media));
                      ...
                      return Transform.rotate(
                        ...
                        child: CLIcon.veryLarge(
                          snapshot.data ?? false
                              ...
                              : MdiIcons.pin,
                          color:
                              snapshot.data ?? false ? Colors.red : Colors.blue,
                        ),
                      );
                    },
                  ),
  ...
  Widget build(BuildContext context) {
    ...
    return GetStoreManager(
      builder: (theStore) {
        ...
        final mediaUri = Uri.file(mediaPath);
        final previewUri = Uri.file(theStore.getPreviewPath2(media));
                ...
                child: Hero(
                  ...
                  child: SafeArea(
                    ...
                    child: switch (media.type) {
                      ...
                      CLMediaType.video => GetVideoController(
                          errorBuilder: BrokenImage.show,
                          loadingBuilder: GreyShimmer.show,
                          builder: (context) {
                            return VideoPlayer(
