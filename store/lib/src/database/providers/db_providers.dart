...
final _resourcesProvider = FutureProvider<(Database, String)>((ref) async {
...
final getTagsByCollectionId =
  ...
  final List<Tag> tags;
  final (db, pathPrefix) = await ref.watch(_resourcesProvider.future);
...
final getMediaByTagId =
  ...
  return CLMediaDB.getByTagId(db, tagID, pathPrefix: pathPrefix);
});
...
final getMediaByCollectionId =
  ...
  final entries =
      CLMediaDB.getByCollectionId(db, collectionId, pathPrefix: pathPrefix);
