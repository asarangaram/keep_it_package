...
class CameraPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return camerasAsync.whenOrNull(
          data: (cameras) {
            return CameraApp(
              cameras: cameras,
            );
...
class _CameraExampleHomeState extends State<CameraExampleHome>
  ...
  XFile? imageFile;
  XFile? videoFile;
  vplayer.VideoPlayerController? videoController;
                    ...
                    : Container(
                        ...
                        child: Center(
                          child: AspectRatio(
                            ...
                            child: vplayer.VideoPlayer(localVideoController),
                          ),
                        ),
                      ),
              ),
  ...
  Future<void> _startVideoPlayer() async {
    ...
    final vController = kIsWeb
        ? vplayer.VideoPlayerController.networkUrl(Uri.parse(videoFile!.path))
        : vplayer.VideoPlayerController.file(File(videoFile!.path));
